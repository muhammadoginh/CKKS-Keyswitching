...
HD_PWD='C:/Users/User/Documents/Projects/CKKS-Keyswitching/CKKS-Keyswitching.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mod_Mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mod_Mul.tcl
